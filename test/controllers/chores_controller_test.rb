...
class ChoresControllerTest < ActionController::TestCase
  ...
  test "should create chore" do
    assert_difference('Chore.count') do
      post :create, chore: { date: @chore.date, estimated_time: @chore.estimated_time, name: @chore.name }
    end
  ...
  test "should update chore" do
    patch :update, id: @chore, chore: { date: @chore.date, estimated_time: @chore.estimated_time, name: @chore.name }
    assert_redirected_to chore_path(assigns(:chore))
  end
